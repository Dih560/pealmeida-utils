...
export function AddDateSeconds(date: string|Date, quantity?: number): Date;
export function AddDateMinutes(date: string|Date, quantity?: number): Date;
...
export function RemoveDateSeconds(date: string|Date, quantity?: number): Date;
export function RemoveDateMinutes(date: string|Date, quantity?: number): Date;
